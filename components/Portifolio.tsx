            ...
            <div className="flex flex-wrap gap-y-3 md:gap-4 justify-center items-center">
                <AnimatePresence>
                    ...
                    transition-all duration-500">
                                    <h1 className="font-poppins-bold uppercase text-center tracking-[3.5] text-white">
                                        {proj?.title}
                                    </h1>
                                    <h5 className="font-lora-medium text-sm text-white mt-1">
                                        {proj?.category.length === 1 ? proj?.category : proj?.category.map((cate, idx) => idx === proj?.category.length - 1 ? cate : cate + " | ")}
                                    </h5>
                                </div>
                            </Link>
                        </motion.div>
